...
.. pros: doesnt waste time on deciding which parts of OS need full HW privilege. Easier to cooperate between diferent parts(buffer and file system).
.. cons: Interfaces between parts of the OS are often complex. Errors make entire kernel to fail.

* Microkernel:  //TODO, SECTION 2.3 XV6
