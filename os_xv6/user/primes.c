...
// 2) drops all numbers that are divisible by the first read number
...
int main(int argc, char *argv[])
{
    ...
    {
        fprintf(1, "limiting prime number to %d\n", MAX_NUMBER_FILEDESCRIPTORS);
        primes_range = MAX_NUMBER_FILEDESCRIPTORS;
    ...
    // flush numbers into prime calculator
